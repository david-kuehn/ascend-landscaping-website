...
export default function TestimonialCarousel() {
  ...
  return (
    <div className="embla">
        ...
        <div className="embla__container">
          ...
          { testimonials.map((testimonial) => 
            <div className="embla__slide" key={testimonial.name}>
              <div className="px-16 sm:px-32 md:px-60 lg:px-96 flex flex-col items-center">
                <Image
                  src={fiveStarsImg}
                  alt=""
                  height={30}
      ...
      <div className="absolute translate-y-[-90px] w-full flex justify-between px-6 sm:px-16 md:px-40 lg:px-64">
